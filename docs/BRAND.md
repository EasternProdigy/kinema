# Kinema — Brand Guidelines

The single source of truth for how Kinema looks and sounds. Mirrors the Pentarosa /
mezi brand kit so the family feels of-a-piece. The visual deck is
[brand/kinema-brand-guidelines.html](brand/kinema-brand-guidelines.html) (open it in a
...
- **Wordmark:** lowercase `kinema`, ink on light / all-white on dark. The wordmark stays
...
| Token | Hex | Role |
|-------|-----|------|
| **Kinema Orange** | `#EE6722` | signal / accent (RGB 238 103 34 · PMS ~165C) |
...
Kinema is **boxy and calm** — boxy over blobby, flat over glassy.
...
**We say:** "Point Kinema at a folder. Press play." · "Your files stay on your machine." ·
...
Lowercase the wordmark (`kinema`) in running text. Mark it as **Kinema — by Pentarosa Co.**
...
- **OG / social banner:** 1200 × 630, gradient background, white `kinema` wordmark + tagline.
- **Contact in collateral:** `opensource@mezi.app` · `github.com/EasternProdigy/kinema`.
